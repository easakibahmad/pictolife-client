      ...
      <div className="lg:w-3/12 w-4/6 mx-auto border pt-12 pb-8">
        ...
        <form action="" className="grid grid-cols-1 md:px-6 px-3 gap-6">
                  ...
                  <input type="text" className='focus:outline-none focus:border-blue-300 border w-full py-1 px-2'/></div>
                            <button type='submit' className="bg-blue-500 font-bold text-white p-1">Log in</button>
          ...
          <div className='lg:w-3/12 flex  mx-auto px-6 py-4 items-center justify-center mt-4 w-4/6 border'>
              <p className='text-center text-sm'>Do not have an account? <span className="text-blue-400 font-bold">Sign up</span></p>
          </div>
    </div>
  );
}
